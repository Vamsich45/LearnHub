            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required
                  className="h-11 dark:bg-black dark:border-gray-600 dark:text-white"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    required
                    className="h-11 pr-10 dark:bg-black dark:border-gray-600 dark:text-white"
                  />
                  <button
                    type="button"
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="remember" className="text-sm text-gray-600 dark:text-white">
                    Remember me
                  </Label>
                </div>
            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white dark:bg-black text-gray-500 dark:text-white">Or continue with</span>
                </div>
              </div>
